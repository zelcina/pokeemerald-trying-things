...
const u32 gObjectEventPic_RubySapphireDawnNormal[] = INCBIN_U32("graphics/object_events/pics/people/ruby_sapphire_dawn/walking.4bpp");
const u32 gObjectEventPic_RubySapphireDawnRunning[] = INCBIN_U32("graphics/object_events/pics/people/ruby_sapphire_dawn/running.4bpp");
const u16 gObjectEventPal_RubySapphireDawn[] = INCBIN_U16("graphics/object_events/palettes/ruby_sapphire_dawn.gbapal");
