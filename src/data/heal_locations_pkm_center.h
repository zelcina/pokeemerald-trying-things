...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_DAWNS_HOUSE_2F - 1] =
    {
        .group = MAP_GROUP(LITTLEROOT_TOWN_DAWNS_HOUSE_1F),
        .map = MAP_NUM(LITTLEROOT_TOWN_DAWNS_HOUSE_1F),
        .x = 2,
        .y = 7,
    },
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_DAWNS_HOUSE - 1] =
    {
        .group = MAP_GROUP(LITTLEROOT_TOWN_DAWNS_HOUSE_1F),
        .map = MAP_NUM(LITTLEROOT_TOWN_DAWNS_HOUSE_1F),
        .x = 2,
...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_DAWNS_HOUSE_2F - 1] = 1,
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_DAWNS_HOUSE - 1] = 1,
