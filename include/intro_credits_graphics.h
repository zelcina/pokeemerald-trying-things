...
extern const struct CompressedSpriteSheet gSpriteSheet_IntroDawn[];
...
extern const struct CompressedSpriteSheet gSpriteSheet_CreditsDawn[];
...
extern const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalDawn[];
