...
#define KANTO_TENT_FUNC_INIT                    0
#define KANTO_TENT_FUNC_GET_PRIZE               1
#define KANTO_TENT_FUNC_SET_PRIZE               2
#define KANTO_TENT_FUNC_SAVE                    3
#define KANTO_TENT_FUNC_SET_RANDOM_PRIZE        4
#define KANTO_TENT_FUNC_GIVE_PRIZE              5
#define KANTO_TENT_FUNC_SELECT_RENT_MONS        6
#define KANTO_TENT_FUNC_SWAP_RENT_MONS          7
#define KANTO_TENT_FUNC_GENERATE_OPPONENT_MONS  8
#define KANTO_TENT_FUNC_GENERATE_RENTAL_MONS    9
